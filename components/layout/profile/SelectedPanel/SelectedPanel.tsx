...
export const SelectedPanel: FC<SelectedPanelProps> = ({ removeSelected, selectAll, countSelected }) => {
  return (
    <div
      className={cn(styles.selected, "mb-10 py-2.5 px-5 bg-white border border-[#F9FAFB] rounded-lg flex justify-between items-center")}>
      <H6 classname="!mb-0">{countSelected} folders selected</H6>
      <p
        onClick={selectAll}
        className="ml-5 text-sm text-main cursor-pointer transition-all hover:opacity-70 select-none">
        Select All
      </p>
      <Button classname="ml-auto mr-5 group" icon="icon-left">
        <svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            ...
            d="M7.50033 1.16663V12.8333M1.66699 6.99996H13.3337" stroke="#344054" strokeWidth="1.66667"
